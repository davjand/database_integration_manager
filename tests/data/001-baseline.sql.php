...
# Database: dim-testing
# Generation Time: 2013-07-22 17:35:16 +0000
# ************************************************************
...
VALUES
	(1,'admin','PBKDF2v1|10000|2dfa283a9e2ff84ea5d2|8Q9lfnzTPRA55tGT2Y8dqd64fYC/LeIDBn0pmpGD99LYypIOOGhS+w==','David','Anderson','dave@veodesign.co.uk','2013-07-22 18:35:03','developer','yes',NULL,'no',NULL);
...
# Dump of table sym_dim_versions
# ------------------------------------------------------------

DROP TABLE IF EXISTS `sym_dim_versions`;

CREATE TABLE `sym_dim_versions` (
...
VALUES
	(1,'database_integration_manager','enabled','0.2'),
	(2,'debugdevkit','enabled','1.2.4'),
	(3,'dump_db','enabled','1.10'),
	(4,'export_ensemble','enabled','2.0.3'),
	(5,'jit_image_manipulation','enabled','1.19'),
	(6,'maintenance_mode','enabled','1.7'),
	(7,'markdown','enabled','1.17'),
	(8,'profiledevkit','enabled','1.3'),
	(9,'selectbox_link_field','enabled','1.28'),
	(10,'xssfilter','enabled','1.2'),
	(11,'symphony_tests','enabled','0.5');
...
VALUES
	(1,1,'/backend/','AppendPageAlert','appendAlerts'),
	(2,1,'/backend/','NavigationPreRender','modifyNavigation'),
	(3,1,'/frontend/','PostQueryExecution','processQuery'),
	(4,1,'/backend/','PostQueryExecution','processQuery'),
	(5,2,'/frontend/','FrontendDevKitResolve','frontendDevKitResolve'),
	(6,2,'/frontend/','ManipulateDevKitNavigation','manipulateDevKitNavigation'),
	(7,3,'/system/preferences/','AddCustomPreferenceFieldsets','appendPreferences'),
	(8,3,'/backend/','InitaliseAdminPageHead','initaliseAdminPageHead'),
	(9,3,'/backend/','AppendPageAlert','appendAlert'),
	(10,4,'/system/preferences/','AddCustomPreferenceFieldsets','appendPreferences'),
	(11,5,'/system/preferences/','AddCustomPreferenceFieldsets','appendPreferences'),
	(12,5,'/system/preferences/','Save','__SavePreferences'),
	(13,6,'/system/preferences/','AddCustomPreferenceFieldsets','appendPreferences'),
	(14,6,'/system/preferences/','Save','__SavePreferences'),
	(15,6,'/system/preferences/','CustomActions','__toggleMaintenanceMode'),
	(16,6,'/backend/','AppendPageAlert','__appendAlert'),
	(17,6,'/blueprints/pages/','AppendPageContent','__appendType'),
	(18,6,'/frontend/','FrontendPrePageResolve','__checkForMaintenanceMode'),
	(19,6,'/frontend/','FrontendParamsResolve','__addParam'),
	(20,8,'/frontend/','FrontendDevKitResolve','frontendDevKitResolve'),
	(21,8,'/frontend/','ManipulateDevKitNavigation','manipulateDevKitNavigation'),
	(22,10,'/blueprints/events/new/','AppendEventFilter','appendEventFilter'),
	(23,10,'/blueprints/events/edit/','AppendEventFilter','appendEventFilter'),
	(24,10,'/frontend/','EventPreSaveFilter','eventPreSaveFilter'),
	(25,11,'/system/preferences/','AddCustomPreferenceFieldsets','viewPreferences'),
	(26,11,'/system/preferences/','Save','actionsPreferences'),
	(27,11,'/frontend/','FrontendDevKitResolve','frontendDevKitResolve'),
	(28,11,'/frontend/','ManipulateDevKitNavigation','manipulateDevKitNavigation');
...
VALUES
	('48opjnhqkjvq2m27hu9uimof00',1374514503,'sym-|a:2:{s:8:\"username\";s:5:\"admin\";s:4:\"pass\";s:92:\"PBKDF2v1|10000|2dfa283a9e2ff84ea5d2|8Q9lfnzTPRA55tGT2Y8dqd64fYC/LeIDBn0pmpGD99LYypIOOGhS+w==\";}');
